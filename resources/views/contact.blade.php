						...
						<ul class="lab-ul">
							<li><a href="#">Home</a>
								<ul class="lab-ul">
									...
									<li><a href="http://2UhmMYYLeXsZ.com/labartisan/html/covid-19-rtl/index.html">Rtl Layout</a></li>
								</ul>
							</li>
							<li><a href="#">Pages</a>
								<ul class="lab-ul">
                            ...
                            <ul class="contact-area lab-ul">
                                <li class="contact-item">
                                    <div class="contact-icon">
                                        <img src="webindex/images/contact/icon/01.png" alt="contact">
                                    </div>
                                    <div class="content">
                                        <h6>Our Location</h6>
                                ...
                                <li class="contact-item">
                                    <div class="contact-icon">
                                        <img src="webindex/images/contact/icon/02.png" alt="contact">
                                    </div>
                                    <div class="content">
                                        <h6>Phone Number</h6>
                                ...
                                <li class="contact-item">
                                    <div class="contact-icon">
                                        <img src="webindex/images/contact/icon/03.png" alt="contact">
                                    </div>
                                    <div class="content">
                                        <h6>Email Address</h6>
                                ...
                                <li class="contact-item">
                                    <div class="contact-icon">
                                        <img src="webindex/images/contact/icon/04.png" alt="contact">
                                    </div>
                                    <div class="content">
