<!DOCTYPE html><html lang="en"><head>
	...
	<body>
						...
						<ul class="lab-ul">
							<li><a href="#">Home</a>
								<ul class="lab-ul">
									...
									<li><a href="http://MMHgPY0qE8rL.com/labartisan/html/covid-19-rtl/index.html">Rtl Layout</a></li>
								</ul>
							</li>
							<li><a href="#">Pages</a>
								<ul class="lab-ul">
							...
							<li class="active"><a href="service.html">Prevention</a></li>
							<li><a href="#">Blog</a>
								<ul class="lab-ul">
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="service-item text-center">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/01.png" alt="service">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item text-center">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/02.png" alt="service">
                                    </div>
                                    <div class="service-content">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item text-center">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/03.png" alt="service">
                                    </div>
                                    <div class="service-content">
                                        <h5>Stay At Home</h5>
                                        <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item text-center">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/04.png" alt="service">
                                    </div>
                                    <div class="service-content">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item text-center">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/05.png" alt="service">
                                    </div>
                                    <div class="service-content">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item text-center">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/06.png" alt="service">
                                    </div>
                                    <div class="service-content">
        ...
        <!-- Service Section Start Here -->
        <section class="service-section style-2 bg_img padding-tb" style="background-image: url(webindex/css/bg-image/bg-4.jpg);">
            <div class="container">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="service-item text-center">
                                    <div class="service-inner">
                                        <div class="service-thumb">
                                            <img src="webindex/images/service/01.jpg" alt="service">
                                        </div>
                                        <div class="service-content">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="service-item text-center">
                                    <div class="service-inner">
                                        <div class="service-thumb">
                                            <img src="webindex/images/service/02.jpg" alt="service">
                                        </div>
                                        <div class="service-content">
                                            <h5>Hot Fever</h5>
                                            <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
                            ...
                            <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="service-item text-center">
                                    <div class="service-inner">
                                        <div class="service-thumb">
                                            <img src="webindex/images/service/03.jpg" alt="service">
                                        </div>
                                        <div class="service-content">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="service-item text-center">
                                    <div class="service-inner">
                                        <div class="service-thumb">
                                            <img src="webindex/images/service/04.jpg" alt="service">
                                        </div>
                                        <div class="service-content">
                            ...
                            <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="service-item text-center">
                                    <div class="service-inner">
                                        <div class="service-thumb">
                                            <img src="webindex/images/service/05.jpg" alt="service">
                                        </div>
                                        <div class="service-content">
                                            <h5>Confusion</h5>
                                            <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
                            ...
                            <div class="col-lg-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="service-item text-center">
                                    <div class="service-inner">
                                        <div class="service-thumb">
                                            <img src="webindex/images/service/06.jpg" alt="service">
                                        </div>
                                        <div class="service-content">
                                            <h5>Sore Throat</h5>
                                            <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
		...
		<section class="service-section home-4 style-2 bg-f6 p-rel padding-tb">
            <div class="home-4-shape">
                <div class="shape">
                    <img src="webindex/images/banner/home-4/home-4-shape.png" alt="service-shape">
                </div>
            </div>
            <div class="container">
                <div class="section-header wow fadeInUp" data-wow-delay="0.3s">
