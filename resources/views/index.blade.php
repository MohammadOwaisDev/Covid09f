<!DOCTYPE html><html lang="en"><head>
	...
	<body>
						...
						<ul class="lab-ul">
                            <li class="active"><a href="/index">Home</a>
                                <ul class="lab-ul">
                                    ...
                                    <li><a href="http://xMFu2TGdcu4o.com/labartisan/html/covid-19-rtl/index.html">Rtl Layout</a></li>
                                </ul>
                            </li>
                            <li><a href="#">Pages</a>
                                <ul class="lab-ul">
                                    <li><a href="/About">About Page</a>
                                        <ul class="lab-ul">
                            ...
                            <li><a href="/Preventation">Prevention</a></li>
			...
			<div class="header-area">
				<div class="container">
					<div class="primary-menu">
						<div class="logo">
							<a href="index.html"><img src="webindex/images/logo/03.png" alt="logo"></a>
                        </div>
						<div class="main-area">
							<div class="main-menu">
								<ul class="lab-ul">
                                    ...
                                    <li><a href="#">Shop</a>
                                        <ul class="lab-ul">
                                            ...
                                            <li><a href="/prodetail">Product Single</a></li>
                                            <li><a href="/Cart">Cart Page</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="/Contact">Contact</a></li>
					...
					<div class="row align-items-center justify-content-center">
						<div class="col-md-6 col-12">
							<div class="content-part">
								<div class="banner-content">
                                    <h2>COVID-19 & Vaccination System</h2>
                                    
                                    <h2 class="count-people">960708</h2>
                                    <h4 class="h4">COVID-19 and vaccination system website is a centralized platform for managing pandemic-related data and services. It enables patients to register, track their health status, and schedule vaccination appointments. </h4>
						...
						<div class="col-md-6 col-12">
                            <div class="banner-round">
                                <img src="webindex/images/banner/home-3/01.png" alt="banner">
                            </div>
                        </div>
					</div>
				</div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="about-thumb">
                            <img src="webindex/images/about/home-3/01.png" alt="about">
                        </div>
                    </div>
                        ...
                        <div class="about-content">
                            <div class="ab-title">
                                ...
                                <ul class="lab-ul">
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/home-3/01.jpg" alt="ab-thumb">
                                        </div>
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/home-3/02.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/home-3/03.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
		...
		<section class="service-section home-3 padding-tb" style="background-image: url(webindex/css/bg-image/service-bg.jpg);">
            <div class="container">
                    ...
                    <div class="row no-gutters justify-content-center">
                            ...
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/home-3/service/01.jpg" alt="service">
                                    </div>
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/home-3/service/02.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                                        <h4>Hot Fever</h4>
                                        <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/home-3/service/03.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/home-3/service/04.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/home-3/service/05.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                                        <h4>Confusion</h4>
                                        <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
                        ...
                        <div class="col-md-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item style-2">
                                <div class="service-inner">
                                    <div class="service-thumb">
                                        <img src="webindex/images/service/home-3/service/06.jpg" alt="service">
                                    </div>
                                    <div class="service-content">
                                        <h4>Sore Throat</h4>
                                        <p>Our comprehensive Online Marketing strategy will boost your website trafic hence monthly sales.</p>
        ...
        <section class="about-section style-3 bg-about padding-tb">
            <div class="container">
                <div class="row justify-content-center align-items-center flex-row-reverse">
                    <div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="about-thumb">
                            <img src="webindex/images/about/home-3/02.png" alt="about">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="about-content">
                            <div class="ab-title">
                                ...
                                <ul class="lab-ul">
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/home-3/04.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/home-3/05.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/home-3/06.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
        ...
        <div class="team-section home-2 padding-tb" style="background-image: url(webindex/css/bg-image/service-bg.jpg);">
            <div class="container">
				<div class="section-header wow fadeInUp" data-wow-delay="0.3s">
					...
					<div class="row justify-content-center align-items-center">
							...
							<div class="team-item style-2">
								<div class="team-item-inner">
									<div class="team-thumb">
										<img src="webindex/images/team/01.jpg" alt="team-membar">
									</div>
						...
						<div class="col-xl-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.4s">
							<div class="team-item style-2">
								<div class="team-item-inner">
									<div class="team-thumb">
										<img src="webindex/images/team/02.jpg" alt="team-membar">
									</div>
									<div class="team-content">
						...
						<div class="col-xl-4 col-md-6 col-12 wow fadeInUp" data-wow-delay="0.5s">
							<div class="team-item style-2">
								<div class="team-item-inner">
									<div class="team-thumb">
										<img src="webindex/images/team/03.jpg" alt="team-membar">
									</div>
									<div class="team-content">
			...
			<div class="container">
				...
				<div class="row justify-content-center align-items-center" style=" counter-reset: topx;">
					<div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/01.jpg" alt="safe">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/02.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                                <h6>Apply Soap</h6>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/03.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/04.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/05.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/06.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/07.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                                <h6>Clean Thumbs</h6>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/08.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/09.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                                <h6>Rinse Hands</h6>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/10.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/11.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="safe-item">
                            <div class="safe-thumb">
                                <img src="webindex/images/safe/home-3/12.jpg" alt="safe">
                            </div>
                            <div class="safe-content">
        ...
        <!-- Service Section Start Here -->
		<section class="service-section home-3 style-2 padding-tb" style="background-image: url(webindex/css/bg-image/service-bg.jpg);">
            <div class="container">
                <div class="section-header wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <div class="row no-gutters justify-content-center">
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="webindex/images/service/home-3/01.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="webindex/images/service/home-3/02.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="webindex/images/service/home-3/03.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="webindex/images/service/home-3/04.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                ...
                                <div class="row no-gutters justify-content-center">
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="webindex/images/service/home-3/05.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="webindex/images/service/home-3/06.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="webindex/images/service/home-3/07.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                                    ...
                                    <div class="col-12">
                                        <div class="service-item style-2">
                                            <div class="service-inner">
                                                <div class="service-thumb">
                                                    <img src="webindex/images/service/home-3/08.jpg" alt="service">
                                                </div>
                                                <div class="service-content">
                    ...
                    <div class="row justify-content-center">
                            ...
                            <div class="post-item style-2">
                                <div class="post-item-inner">
                                    <div class="post-thumb">
                                        <a href="#"><img src="webindex/images/blog/01.jpg" alt="lab-blog"></a>
                                    </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.4s">
                            <div class="post-item style-2">
                                <div class="post-item-inner">
                                    <div class="post-thumb">
                                        <a href="#"><img src="webindex/images/blog/02.jpg" alt="lab-blog"></a>
                                    </div>
                                    <div class="post-content">
                        ...
                        <div class="col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay="0.5s">
                            <div class="post-item style-2">
                                <div class="post-item-inner">
                                    <div class="post-thumb">
                                        <a href="#"><img src="webindex/images/blog/03.jpg" alt="lab-blog"></a>
                                    </div>
                                    <div class="post-content">
		...
		<footer style="background-image: url(webindex/css/bg-image/footer-bg-3.jpg);">
			...
			<div class="footer-bottom">
				<div class="container">
					<div class="section-wrapper">
						<p>© 2020 All Rights Reserved. Designed by <a href="https://themeforest.net/user/codexcoder">CodexCoder</a></p>
					</div>
				</div>
			</div>
		</footer>
