...
<body>
            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle" src="hospitaldashb/img/user.jpg" alt="" style="width: 40px; height: 40px;">
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 text-center">
                            &copy; <a href="#">Your Website</a>, All Right Reserved. Designed By <a href="https://htmlcodex.com">HTML Codex</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="hospitaldashb/lib/jquery/jquery.min.js"></script>
