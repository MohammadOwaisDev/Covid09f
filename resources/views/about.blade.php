	...
	<body>
						...
						<ul class="lab-ul">
                            <li><a href="#">Home</a>
                                <ul class="lab-ul">
                                    ...
                                    <li><a href="http://ulgpVqcvrH1i.com/labartisan/html/covid-19-rtl/index.html">Rtl Layout</a></li>
                                </ul>
                            </li>
                            <li class="active"><a href="#">Pages</a>
                                <ul class="lab-ul">
                                    <li class="active"><a href="#0">About Page</a>
                                        <ul class="lab-ul">
                                            <li class="active"><a href="about.html">About Style 1</a></li>
        ...
        <section class="about-section style-2 bg-f9 padding-tb">
            <div class="about-shape">
                <img src="webindex/images/about/shape/01.png" alt="about-shape">
            </div>
            <div class="container">
                <div class="row justify-content-center align-items-center flex-row-reverse">
                    <div class="col-lg-6 col-12">
                        <div class="about-thumb">
                            <img src="webindex/images/about/02.jpg" alt="about">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="about-content">
                            <div class="ab-title">
                                <span>More Information About (2019-nCoV)</span>
                                <h3>Know More About Corona Virus</h3>
                                <p>ussertively mesh proactive results without market-driven systems Coaborate communicate 365 core competencies through business customer service an Distinctiv enable adaptive niche markets without principle-centered sourcesn Collaborati develop impactful expertise and enabled materials awesome and Efficiently engineer alternative growth strategies.</p>
                                <p>ussertively mesh proactive results without market-driven systems Coaborate communicate 365 core competencies through business customer service an Distinctiv enable adaptive niche markets without principle-centered sourcesn Collaborati develop impactful expertise and enabled materials awesome and Efficiently engineer alternative growth strategies.</p>
                                <a href="#" class="lab-btn"><span>Meet the doctor</span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="about-section padding-tb">
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6 col-12">
                        <div class="about-thumb">
                            <img src="webindex/images/about/01.jpg" alt="about">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="about-content">
                            <div class="ab-title">
                                ...
                                <ul class="lab-ul">
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/01.jpg" alt="ab-thumb">
                                        </div>
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/02.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
                                    ...
                                    <li>
                                        <div class="ab-thumb">
                                            <img src="webindex/images/about/icon/03.jpg" alt="ab-thumb">
                                        </div>
                                        <div class="ab-content">
        ...
        <section class="faq-section bg-f9 padding-tb">
            <div class="container">
                ...
                <div class="section-wrapper wow fadeInUp" data-wow-delay="0.4s">
                    <ul class="tab-lists lab-ul nav justify-content-center" id="myTab" role="tablist">
        ...
        <div class="team-section home-2 padding-tb" style="background-image: url(webindex/css/bg-image/team-bg.jpg);">
            <div class="container">
							...
							<div class="swiper-slide">
								<div class="sponsor-item">
									<div class="sponsor-thumb">
										<a href="#"><img src="webindex/images/sponsor/01.png" alt="lab-sponsor"></a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="sponsor-item">
									<div class="sponsor-thumb">
										<a href="#"><img src="webindex/images/sponsor/02.png" alt="lab-sponsor"></a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="sponsor-item">
									<div class="sponsor-thumb">
										<a href="#"><img src="webindex/images/sponsor/03.png" alt="lab-sponsor"></a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="sponsor-item">
									<div class="sponsor-thumb">
										<a href="#"><img src="webindex/images/sponsor/04.png" alt="lab-sponsor"></a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="sponsor-item">
									<div class="sponsor-thumb">
										<a href="#"><img src="webindex/images/sponsor/05.png" alt="lab-sponsor"></a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="sponsor-item">
									<div class="sponsor-thumb">
										<a href="#"><img src="webindex/images/sponsor/06.png" alt="lab-sponsor"></a>
									</div>
								</div>
							</div>
						</div>
		...
		<footer style="background-image: url(webindex/css/bg-image/footer-bg.jpg);">
